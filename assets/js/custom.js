(function ($) {
	...
	// 			gravity: { x: 0, y: 2 }, // Less gravity to prevent infinite falling
	// 			damping: 0.9,
	// 			containment: "parent", // Ensures balls stay inside #container
	// 			collisionDetection: true, // Enables bouncing
	// 			bounce: 0.2, // Makes the balls bounce off the walls instead of falling through
	// 		});
	// 	} else {
	// 		console.warn("Throwable plugin is not loaded on this page.");
	// 	}
	// });
